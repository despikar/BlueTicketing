...
class customersupport implements User {
    private String userName;
    private String password;
    private int userType;
	
    public customersupport(String userName, String password, int userType) {
    ...
    public void performActions() {
        try {
            ...
            try (BufferedReader br = new BufferedReader(new FileReader("customersupport.txt"))) {
                String line;
            ...
            for (int i = 0; i < lines.size(); i++) {
                ...
                if (line.endsWith(",0")) {
                    ...
                    if (end == 2) {
                        System.out.println("Ok, ending responding process");
                        break;
                    } else if (end != 1) {
            ...
            try (PrintWriter writer = new PrintWriter(new FileWriter("customersupport.txt"))) {
